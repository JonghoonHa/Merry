...
CMerryDoc::CMerryDoc()
{
	...
	temp.actionPoint.push_back(877);
	temp.moveVector.push_back(glm::vec3(5.0,0.0,-3.0));
	temp.distLimit.push_back(800.0);

	temp.actionPoint.push_back(877);
	temp.moveVector.push_back(glm::vec3(7.0,0.0,4.0));
	temp.distLimit.push_back(600.0);
	...
	temp.moveVector.push_back(glm::vec3(0.0,5.0,3.0));
	temp.distLimit.push_back(300.0);

	temp.actionPoint.push_back(1253);
	temp.moveVector.push_back(glm::vec3(0.0,0.0,3.0));
	temp.distLimit.push_back(300.0);
